...
async def pause(_, message: Message):
    try:
      ...
      await message.reply("Pɪᴋᴀ Pɪᴋᴀ, Is Yᴏᴜʀ Cʜᴀᴛ Aʟʀᴇᴀᴅʏ Cᴏɴɴᴇᴄᴛᴇᴅ ?")
      return    
    chat_id = chid
    if (chat_id not in callsmusic.pytgcalls.active_calls) or (
        callsmusic.pytgcalls.active_calls[chat_id] == "paused"
    ):
        await message.reply_text("❗Pɪᴋᴀ Pɪᴋᴀ, Aᴍ Nᴏᴛʜɪɴɢ Is Pʟᴀʏɪɴɢ!")
    else:
...
async def resume(_, message: Message):
    ...
    if (chat_id not in callsmusic.pytgcalls.active_calls) or (
        ...
        await message.reply_text("❗ Pɪᴋᴀ Pɪᴋᴀ, Aᴍ Nᴏᴛʜɪɴɢ Is Pᴀᴜsᴇᴅ!")
    else:
...
async def stop(_, message: Message):
    ...
    if chat_id not in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_text("⏹ Pɪᴋᴀ Pɪᴋᴀ, Aᴍ Eɴᴅᴇᴅ Sᴛʀᴇᴀᴍɪɴɢ!")
...
async def skip(_, message: Message):
    ...
    chat_id = chid
    if chat_id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❗Pɪᴋᴀ Pɪᴋᴀ, Nᴏᴛʜɪɴɢ Is Pʟᴀʏɪɴɢ Tᴏ Sᴋɪᴘ!")
    else:
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("✅ Pɪᴋᴀ Pɪᴋᴀ, Rᴇғʀᴇsʜᴇᴅ!")
